...
| `SECRET_COMMENT_HMAC_KEY`   | A random string used for HMAC token generation.<br/> Select a long and strong random string. | string  |      --       |
| `SECRET_ADMIN_JWT_KEY`      | A random string used for admin login JWT.<br/> Select a long and strong random string.       | string  |      --       |
...
SECRET_COMMENT_HMAC_KEY=956be06a6eb1eee252e1405ce8e113c4055b5e0adce17f16
CORS_ORIGIN=*
```
