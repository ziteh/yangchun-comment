...
```bash
# HMAC secret key
pnpm exec wrangler secret put "SECRET_COMMENT_HMAC_KEY"

# Admin JWT signature key
pnpm exec wrangler secret put "SECRET_ADMIN_JWT_KEY"
